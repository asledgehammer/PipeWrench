...
declare module '@asledgehammer/pipewrench/client' {
  export namespace lua.client.Entity.ISUI.Controls {
    ...
    export class ISWidgetEntityDebug extends lua.client.ISUI.ISPanel {
      [id: string]: any;
      ...
      constructor(x: any, y: any, width: any, height: any, player: any, entity: any, _styleButton: any);
  ...
  export namespace lua.client.Entity.ISUI.Controls.ISWidgetEntityDebug {}
}
