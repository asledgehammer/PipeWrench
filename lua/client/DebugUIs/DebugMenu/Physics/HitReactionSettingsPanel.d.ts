...
declare module '@asledgehammer/pipewrench/client' {
  export namespace lua.client.DebugUIs.DebugMenu.Physics {
    ...
    export class HitReactionSettingsPanel extends lua.client.DebugUIs.DebugMenu.Base.ISDebugSubPanelBase {
      [id: string]: any;
  ...
  export namespace lua.client.DebugUIs.DebugMenu.Physics.HitReactionSettingsPanel {}
}
