...
declare module '@asledgehammer/pipewrench' {
  export namespace lua.shared.Moveables {
    ...
    export abstract class ISMoveableSpriteProps {
      ...
      canRepairObject: ((_character: any) => any) | any;

      canRepairObjectInternal: ((_result: any, _object: any) => any) | any;
      ...
      checkForRepairPart: ((_inventory: any, _itemType: any, _amount: any, _consume: any) => any) | any;

      consumeRepairPart: ((_inventory: any, _itemType: any, _amount: any) => any) | any;
      ...
      getAdditionalObjects: ((_object: any) => any) | any;

      getAllRepairParts: (() => any) | any;
      ...
      getPartsString: ((_inventory: any, _parts: any) => any) | any;

      getRepairActionTime: ((_player: any) => any) | any;

      getRepairDamageFactor: ((_object: any) => any) | any;

      getRepairPartsForMaterial:
        | ((_material: any, _partTable: any, _damageFactor: any, _objectCount: any) => any)
        | any;

      getRepairSkillChance: ((_player: any) => any) | any;

      getRepairSound: ((_character: any) => any) | any;
      ...
      hasRepairParts: ((_player: any) => any) | any;

      hasRepairTool: ((_player: any, _doSecond: any) => any) | any;
      ...
      isBreakablePlant: ((_object: any) => any) | any;
      ...
      repairHaloNoteCheck: ((_character: any, _didRepair: any) => any) | any;

      repairObject: ((_character: any) => any) | any;

      repairObjectInternal: ((_character: any) => any) | any;

      repairObjectViaCursor: ((_character: any, _square: any, _origSpriteName: any, _moveCursor: any) => any) | any;
      ...
      walkAdj: ((character: any, square: any, keepActions: any) => any) | any;
      ...
      /** @noSelf */
      static fromObjectForRepair: (_object: any, ...__args: never[]) => any;
  ...
  export namespace lua.shared.Moveables.ISMoveableSpriteProps {}
}
