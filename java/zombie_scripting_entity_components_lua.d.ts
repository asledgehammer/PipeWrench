...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.scripting.entity.components.lua {
    /**
     * @customConstructor LuaComponentScript.new
     * @
     * [CLASS] zombie.scripting.entity.components.lua.LuaComponentScript extends zombie.scripting.entity.ComponentScript
     */
    export class LuaComponentScript {
