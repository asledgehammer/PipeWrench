...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.scripting.entity.components.ui {
    /**
     * @customConstructor UiConfigScript.new
     * @
     * [CLASS] zombie.scripting.entity.components.ui.UiConfigScript extends zombie.scripting.entity.ComponentScript
     */
    export class UiConfigScript {
