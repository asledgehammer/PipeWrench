...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.scripting.entity.components.test {
    /**
     * @customConstructor TestComponentScript.new
     * @
     * [CLASS] zombie.scripting.entity.components.test.TestComponentScript extends zombie.scripting.entity.ComponentScript
     */
    export class TestComponentScript {
