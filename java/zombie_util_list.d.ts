...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.util.list {
     ...
     * @
     * [CLASS] zombie.util.list.PZUnmodifiableList extends zombie.util.list.PZUnmodifiableCollection<E>
     */
    export class PZUnmodifiableList<E> {
       ...
       *  - (int arg0, Collection arg1): boolean
       */
      addAll(arg0: java.util.Collection<any> | number, arg1?: java.util.Collection<E>): boolean;
      /**
       * Method Parameters: 
       *  - (Empty): void
       */
       ...
       *
       * Method Parameters: 
       *  - (List arg0): java.util.List<T>
       */
      static wrap<T>(arg0: java.util.List<T>): java.util.List<T>;
    }
  }
}
