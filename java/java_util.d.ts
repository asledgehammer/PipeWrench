...
declare module '@asledgehammer/pipewrench' {
  export namespace java.util {
    ...
    export class LinkedList<E> {
       ...
       *  - (int arg0): java.util.ListIterator<E>
       */
      listIterator<T>(arg0?: number): java.util.ListIterator<E> | java.util.ListIterator<any>;
      /**
       * Method Parameters: 
       *  - (Object arg0): boolean
       */
    ...
    export class Stack<E> {
       ...
       *  - (int arg0, Collection arg1): boolean
       */
      addAll<T>(arg0: number | java.util.Collection<any>, arg1?: java.util.Collection<any>): boolean;
      /**
       * Method Parameters: 
       *  - (Object arg0): void
       */
