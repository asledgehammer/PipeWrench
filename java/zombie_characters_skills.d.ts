...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.characters.skills {
    ...
    export class PerkFactory$Perk {
       ...
       */
      constructor(arg0: string, arg1?: zombie.characters.skills.PerkFactory$Perk);
      /**
       * Method Parameters: 
       *  - (Empty): string
       */
