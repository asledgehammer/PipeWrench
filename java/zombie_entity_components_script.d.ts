...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.entity.components.script {
    /**
     * @customConstructor EntityScriptInfo.new
     * @
     * [CLASS] zombie.entity.components.script.EntityScriptInfo extends zombie.entity.Component
     */
    export class EntityScriptInfo {
       ...
       */
      setOriginalScript(arg0: zombie.scripting.entity.GameEntityScript): void;
      /**
       * Method Parameters: 
       *  - (Empty): string
       */
