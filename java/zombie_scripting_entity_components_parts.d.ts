...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.scripting.entity.components.parts {
    /**
     * @customConstructor PartsScript.new
     * @
     * [CLASS] zombie.scripting.entity.components.parts.PartsScript extends zombie.scripting.entity.ComponentScript
     */
    export class PartsScript {
