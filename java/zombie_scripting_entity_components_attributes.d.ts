...
declare module '@asledgehammer/pipewrench' {
  export namespace zombie.scripting.entity.components.attributes {
    /**
     * @customConstructor AttributesScript.new
     * @
     * [CLASS] zombie.scripting.entity.components.attributes.AttributesScript extends zombie.scripting.entity.ComponentScript
     */
    export class AttributesScript {
       ...
       */
      getTemplateContainer(): zombie.entity.components.attributes.AttributeContainer;
      /**
       * Method Parameters: 
